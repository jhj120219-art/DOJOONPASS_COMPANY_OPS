...
본 저장소와 `DOJOONPASS_OS` 사이의 Source of Truth 경계, 참조 방향, 변경 관리 규칙은 `DOJOONPASS_OS/00_foundation/04_repository_contract.md`의 「COO ↔ COMPANY_OPS Repository Contract v1」을 따른다.
...
├─ 12_APPLICATION_FLOW_SPEC.md
├─ 13_NOTION_ENVIRONMENT_SETUP.md
├─ 14_RUN_CONTRACT.md
└─ 15_D1_COMPANY_UPDATE_SPEC.md
```
